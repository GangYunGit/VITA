    ...
    <div id="wearable-friend-Rhr">
      <div id="wearable-friend-Rhr-Left">
        <div id="wearable-friend-Rhr-Left-div">
          <div id="wearable-friend-Rhr-chartdiv"></div>
        </div>
      </div>
      <div id="wearable-friend-Rhr-Right">
        <div id="wearable-friend-Rhr-rank">
          <img
            id="wearable-friend-Rhr-rank-img"
            :src="require(`/public/wearable-friend/fwrank.png`)"
          />
          <div id="wearable-friend-Rhr-rank-h1">랭킹</div>
          <div
            id="wearable-friend-Rhr-rank-item"
...
export default {
  ...
  mounted() {
    ...
    am5.ready(() => {
      ...
      var root = am5.Root.new("wearable-friend-Rhr-chartdiv");
...
#wearable-friend-Rhr-Right {
  width: 30%;
  height: 500px;
  float: left;
  /* background-color: bisque; */
}
#wearable-friend-Rhr-rank {
...
#wearable-friend-Rhr-rank-h1 {
  font-weight: 600;
  font-size: 1.5rem;
}
#wearable-friend-Rhr-rank-img {
  margin-top: -30px;
}
#wearable-friend-Rhr-rank-item {
  font-weight: 600;
  margin: 0.5rem;
}
</style>