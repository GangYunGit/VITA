package com.ssafy.vitauser.common;
...
public class ApiResponse<T> {
    ...
    private final static int NOT_REGISTERED_EXTRA_INFO = 300;
    private final static int NOT_FOUND = 400;
    private final static int FAILED = 500;
    private final static String SUCCESS_MESSAGE = "SUCCESS";
    private final static String NOT_REGISTERED_MESSAGE = "추가 정보를 등록해야 합니다.";
    ...
    public static <T> ApiResponse<T> notRegisteredExtraInfo(String name, T body) {
        Map<String, T> map = new HashMap<>();
        map.put(name, body);

        return new ApiResponse<>(new ApiResponseHeader(NOT_REGISTERED_EXTRA_INFO, NOT_REGISTERED_MESSAGE), map);
    }
